...
| profile | platform | followers | key evidence | role |
|---|---|---:|---|---|
| [`@tszzl`](https://x.com/tszzl) roon | X | 366k | “the beauty of twitter was the simcluster” (12 Jul 2024) | origin of the memetic X usage |
| [`@nearcyan`](https://x.com/nearcyan) | X | 164k | “list of lists from my simcluster” — 797 likes | lament → ordinary shorthand |
| [`@ludwigABAP`](https://x.com/ludwigABAP) | X | 47k | “every non-tech banger … escapes my simcluster” | “escape the niche, lose context” variant |
| [`@keysmashbandit`](https://x.com/keysmashbandit) | X | 16k | “I miss my simcluster” | distilled complaint form |
| [`@Prigoose`](https://x.com/Prigoose) | X | 6.5k | assumed a tweet “would just be shown to my simcluster” | naturalises the term into everyday posting |
| [`@altryne`](https://x.com/altryne) | X | 41k | post “left our AI simcluster” → “almost 5M impressions” | AI-Twitter boundary usage |
| [`@awssnarkitect`](https://bsky.app/profile/awssnarkitect.bsky.social) | Bluesky | n/a | “small simcluster can feel like the entire internet” | Bluesky theorist of simcluster-localism |
| [`@abeliansoup`](https://bsky.app/profile/abeliansoup.bsky.social) | Bluesky | n/a | Simcluster Museum; ART PROJECTS THREAD; bskyshelf | curator/cartographer of the Bluesky phase |
| [`@norvid-studies`](https://bsky.app/profile/norvid-studies.bsky.social) | X + Bluesky | n/a | “THE SIMCLUSTER GETS A TIME MACHINE”; boosted 3.4M-user map | bridge account X→Bluesky |
| [`@gracekind`](https://bsky.app/profile/gracekind.net) | Bluesky | 6.9k | “simcluster art videos” — 233 likes, 60 reposts | meme becomes aesthetic object |
